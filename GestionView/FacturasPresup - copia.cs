...
namespace Promowork
{
    public partial class FacturasPresup : Form
    {
        ...
        private void facturasCabBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            {
                facturaIncorrectaTableAdapter.Fill(promowork_dataDataSet.FacturaIncorrecta, VariablesGlobales.nIdEmpresaActual, (DateTime)fechaFacturaDateTimePicker.Value, (bool)facturaCheckBox.Checked, int.Parse(numFacturaTextBox.Text), nIdFactura);
      ...
      private void facturasCabDataGridView_CellEnter(object sender, DataGridViewCellEventArgs e)
       ...
       private void FacturasPresup_Activated(object sender, EventArgs e)
       {
         //  MessageBox.Show("aaaaa");
           this.anosFacturasTableAdapter.FillByFactPresup(promowork_dataDataSet.AnosFacturas, VariablesGlobales.nIdEmpresaActual);
           cbxanos.SelectedValue = VariablesGlobales.nAnoActual;
