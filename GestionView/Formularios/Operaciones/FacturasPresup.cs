...
namespace Promowork.Formularios.Operaciones
{
    public partial class FacturasPresup : Form
    {
      ...
      private void facturasCabDataGridView_CellEnter(object sender, DataGridViewCellEventArgs e)
       ...
       private void FacturasPresup_Load_1(object sender, EventArgs e)
       {
       ...
       {
           FacturasPresup_Load_1(null, null);

           //DataRowView facturas = (DataRowView)facturasCabBindingSource.Current;
           //textEdit1.EditValue = facturas["NumFactura"];
       }
