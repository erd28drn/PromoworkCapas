...
namespace Promowork.Formularios.Reportes.Viewer
{
    public partial class RptFacturasHorasImpParte : Form
    {
        ...
        internal void LoadFiltro(int nIdFactCab, bool unificarMaterial)
        {
            ...
            if (unificarMaterial)
            {
                this.reportViewer1.LocalReport.ReportEmbeddedResource = "Promowork.Reportes.FacturaHorasMatImpParte.rdlc";
            }
