...
namespace Promowork
{
    public partial class ObraCompletaColores : Form
    {
        ...
        internal void LoadParametros(DataTable Obras, Boolean IncCobros, DateTime FechaInicio, DateTime FechaFin)
        {
            ...
            try
            {
                    this.ResumenObraCompletaTableAdapter.Fill(this.Promowork_dataDataSet.ResumenObraCompleta, Obras,FechaInicio, FechaFin, -65536, -16776961, -16777216,true);
