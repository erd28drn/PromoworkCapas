...
namespace Promowork
{
    public partial class RptParametrosSalarioExtraTrabajadores : Form
    {
        public RptParametrosSalarioExtraTrabajadores()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                RptSalarioExtraTrabajadores frm = new RptSalarioExtraTrabajadores();
                frm.LoadParametros(dateTimePicker1.Value, dateTimePicker2.Value, tmpObras, tmpTRabajadores, chkIncAusencias.Checked, chkIncSinParte.Checked);
