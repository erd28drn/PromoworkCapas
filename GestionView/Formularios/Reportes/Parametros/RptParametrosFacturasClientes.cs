    ...
    public partial class RptParametrosFacturasClientes : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frm.LoadParametros(dateTimePicker1.Value, dateTimePicker2.Value, tmpClientes, checkBox1.Checked, checkBox3.Checked, checkBox4.Checked, chkCliFactura.Checked);
