...
namespace Promowork
{
    public partial class RptHojaTrabajadores : Form
    {
        public RptHojaTrabajadores()
        {
            InitializeComponent();
        }
        ...
        private void RptHojaTrabajadores_Load(object sender, EventArgs e)
        {
           ...
           this.EmpresasActualTableAdapter.FillByEmpresa(this.Promowork_dataDataSet.EmpresasActual, VariablesGlobales.nIdEmpresaActual);
            ...
            hojaTrabajadoresObras.Fill(Promowork_dataDataSet.HojaTrabajadoresObras,AnoEmpresa, MesEmpresa,VariablesGlobales.nIdEmpresaActual);
