namespace Promowork
{
    partial class RptHojaTrabajadores
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.hojaTrabajadoresObrasBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            this.hojaTrabajadoresObras = new GestionData.Promowork_dataDataSetTableAdapters.HojaTrabajadoresObras();
            this.tableAdapterManager = new GestionData.Promowork_dataDataSetTableAdapters.TableAdapterManager();
            ((System.ComponentModel.ISupportInitialize)(this.hojaTrabajadoresObrasBindingSource)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.Promowork_dataDataSet)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.EmpresasActualBindingSource)).BeginInit();
            this.SuspendLayout();
            // 
            // hojaTrabajadoresObrasBindingSource
            // 
            this.hojaTrabajadoresObrasBindingSource.DataMember = "HojaTrabajadoresObras";
            this.hojaTrabajadoresObrasBindingSource.DataSource = this.Promowork_dataDataSet;
            // 
            ...
            reportDataSource1.Value = this.hojaTrabajadoresObrasBindingSource;
            reportDataSource2.Name = "DataSet2";
            reportDataSource2.Value = this.EmpresasActualBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Promowork.HojaTrabajadores.rdlc";
            ...
            // 
            // hojaTrabajadoresObras
            // 
            this.hojaTrabajadoresObras.ClearBeforeFill = true;
            // 
            // tableAdapterManager
            // 
            ...
            this.Name = "RptHojaTrabajadores";
            this.ShowIcon = false;
            this.ShowInTaskbar = false;
            this.Text = "Parte Obras (Obras)";
            this.Load += new System.EventHandler(this.RptHojaTrabajadores_Load);
            ((System.ComponentModel.ISupportInitialize)(this.hojaTrabajadoresObrasBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource hojaTrabajadoresObrasBindingSource;
        private GestionData.Promowork_dataDataSetTableAdapters.HojaTrabajadoresObras hojaTrabajadoresObras;
